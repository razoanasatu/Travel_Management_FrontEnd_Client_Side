export default function Footer() {
  return (
    <>
      <div className="py-9" style={{ background: "#2E52B0" }}>
      ...
      <div
        className="flex items-center justify-center pb-8 pt-[9px] md:py-8"
        style={{ background: "#341F67" }}
      >
        <p className="text-[10px] font-normal text-white md:text-[12px]">
          © Copyright 2025, All Rights Reserved by YOUR WEBSITES. PVT. LTD
        </p>
      </div>
    </>
  );
